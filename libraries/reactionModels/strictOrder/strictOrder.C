...
{
defineTypeNameAndDebug(strictOrder, 0);
...
Foam::reactionModels::strictOrder::strictOrder
(
...
void Foam::reactionModels::strictOrder::correct(bool massConservative)
{
...
Foam::tmp<Foam::fvScalarMatrix> Foam::reactionModels::strictOrder::reactionTerm
(
...
bool Foam::reactionModels::strictOrder::needsSubcycling() const
{
    return true;
}

bool Foam::reactionModels::strictOrder::alwaysMassConservative() const
{
    return false;
}


void Foam::reactionModels::strictOrder::postTransport()
{}

// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * //

Foam::label Foam::reactionModels::strictOrder::addReaction
(
...
void Foam::reactionModels::strictOrder::addSecondOrderReaction
(
    const List<specieCoeffs>& lhs,
    const List<specieCoeffs>& rhs,
    const dimensionedScalar& k,
...
void Foam::reactionModels::strictOrder::addFirstOrderReaction
(
    const List<specieCoeffs>& lhs,
    const List<specieCoeffs>& rhs,
    const dimensionedScalar& k,
...
void Foam::reactionModels::strictOrder::addZerothOrderReaction
(
    const List<specieCoeffs>& lhs,
    const List<specieCoeffs>& rhs,
    const dimensionedScalar& k
...
Foam::tmp<Foam::fvScalarMatrix> Foam::reactionModels::strictOrder::computeReactionTerm
(
    const label speciesi,
    bool implicit
) const
